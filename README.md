...
| [deepseek](https://github.com/wlc952/deepseek_aigchub.git)           | DeepSeek_R1_Distill_Qwen 系列专用      |          | `/v1/chat/completions`      |                      |
...
| [sherpa](https://github.com/wlc952/Kaldi-TPU.git)                    | sherpa-onnx 语言转文本                |  255 MB  | `/v1/audio/transcriptions` |                       |
...
| [roop_face](https://github.com/ZillaRU/roop_face.git)                | 人像换脸<br>人脸增强                 | 1075 MB  | `/v1/images/variations`<br>`/v1/images/edit` |               |
| [sd_lcm](https://github.com/ZillaRU/SD-lcm-tpu)                      | SD文生图、图生图                     | 7308 MB  | `/v1/images/generations`<br>`/v1/images/edit` |              |
| [rmbg](https://github.com/wlc952/rmbg_tpu.git)                       | 图像去背景                          |  88 MB   | `/v1/images/edit`          |                       |
| [img2txt](https://github.com/ZillaRU/ImageSpeaking.git)              | 看图说话、生成图像描述               |  6 GB    | `/v1/images/variations`    |                       |
| [upscaler](https://github.com/ZillaRU/upscaler_tpu.git)              | 图像超分                            |   45 M   | `/v1/images/edit`          |              |
| [gpt_sovits](https://github.com/wlc952/GPT-SoVITS-TPU.git)           | 音色克隆                            | 2203 MB | `/v1/audio/speech`        |              |
| [indextts](https://github.com/wlc952/index-tts.git)               | 音色克隆                            | 823 MB | `/v1/audio/speech`        |              |
...
```sh
bash scripts/init_app.sh app.txt中的应用名称
```

其中 `app.txt中的应用名称`可以是多个，用空格分开。比如 `bash scripts/init_app.sh emotivoice sherpa`。
