...
class AppInitializationRouter(BaseAPIRouter):
    async def init_app(self):
        ...
        self.register_model("llm_general_v2", LLMBasePipeline(args))
...
async def chat_completions(request: ChatRequest):
    slm = router.require_model("llm_general_v2")
    slm.ID_EOS = [slm.EOS]  # Ensure EOS is a list for compatibility
