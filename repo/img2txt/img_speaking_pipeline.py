...
bmodel_dir = os.path.join(sdk_dir, 'bmodels/img2txt')

class ImageSpeakingPipeline:
    def __init__(self,
        swin_path=f"{bmodel_dir}/t2t/swin_f16.bmodel",
        tagging_head_path=f"{bmodel_dir}/t2t/tagging_head_f16.bmodel",
        tag_encoder_path=f"{bmodel_dir}/ram/tag_encoder.bmodel",
        tag_decoder_path=f"{bmodel_dir}/t2t/encoder_f32.bmodel",
        tag_list='./resources/tag_list/tag2text_ori_tag_list.txt',
        label_embed_path=f"{bmodel_dir}/t2t/label_embed.npz",
        tokenizer_path='./resources/bert-base-uncased',
        bert_path_first=f"{bmodel_dir}/bert/ram_bert4_F16.bmodel",
        bert_cls_first_path=f"{bmodel_dir}/bert/bert_cls_first_F16.bmodel",
        bert_cls_path=f"{bmodel_dir}/bert/bert_cls_F16.bmodel",
        device_id=0
    ):
        self.bert_modules = [EngineOV(f"{bmodel_dir}/bert/ram_bert{i}_F16.bmodel", device_id=device_id) for i in range(5, 25)]
