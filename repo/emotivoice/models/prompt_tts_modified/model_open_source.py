...
import numpy as np
from .. import EngineOV, bmodels_path
...
class PromptTTS(nn.Module):
    def __init__(self, config) -> None:
        ...
        self.encoder = EngineOV(f"{bmodels_path}/tts/jit_am_encoder_1-512-384_1-1-512.bmodel")

        self.decoder = EngineOV(f"{bmodels_path}/tts/onnx_am_decoder_1-2048-384.bmodel")

        self.duration_predictor = EngineOV(f"{bmodels_path}/tts/am_durationpred-1_512_384-1_512_1.bmodel")

        self.pitch_predictor = EngineOV(f"{bmodels_path}/tts/am_pitchpred-1_512_384-1_512_1.bmodel")
        ...
        self.energy_predictor = EngineOV(f"{bmodels_path}/tts/am_energypred-1_512_384-1_512_1.bmodel")
        ...
        model_para_dict = torch.load(f"{bmodels_path}/tts/am_rest_weight.pth")
