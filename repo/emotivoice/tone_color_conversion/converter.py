...
from . import modules
from models import EngineOV, bmodels_path
import numpy as np
...
class PosteriorEncoder(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.model_core = EngineOV(f"{bmodels_path}/converter/myenc_f32.bmodel", device_id=0)
...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.dec = EngineOV(f"{bmodels_path}/converter/decoder_2048_f16.bmodel", device_id=0)
        ...
        self.flow = EngineOV(f"{bmodels_path}/converter/flow_f32.bmodel", device_id=0)

        self.flow_reverse = EngineOV(f"{bmodels_path}/converter/flow_reverse_f32.bmodel", device_id=0)

        self.ref_enc = EngineOV(f"{bmodels_path}/converter/ref_enc_F32.bmodel", device_id=0)
