    ...
    try:
        ...
        class FaceRestorerCodeFormer(FaceRestoration):
            ...
            def create_models(self, bmodel_path):
                ...
                face_helper = FaceRestoreHelper(1, face_size=512, crop_ratio=(1, 1), model_path=bmodel_path, save_ext='png', use_parse=True)
                net = EngineOV(model_path=f"{bmodel_path}/codeformer_1-3-512-512_1-235ms.bmodel", device_id=0)
                self.net = net
