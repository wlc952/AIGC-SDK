...
PYBIND11_MODULE(chat, m) {
  pybind11::class_<Qwen2_5VL>(m, "Qwen2_5VL")
      .def(pybind11::init<>())
      .def("init", &Qwen2_5VL::init)
      .def("forward_embed", &Qwen2_5VL::forward_embed)
      .def("forward_vit", &Qwen2_5VL::forward_vit)
      .def("forward_first", &Qwen2_5VL::forward_first)
      .def("forward_next", &Qwen2_5VL::forward_next)
      .def("clear_history", &Qwen2_5VL::clear_history)
      .def("deinit", &Qwen2_5VL::deinit)
      ...
      .def_readonly("MAX_INPUT_LENGTH", &Qwen2_5VL::MAX_INPUT_LENGTH)
      .def_readonly("PREFILL_KV_LENGTH", &Qwen2_5VL::PREFILL_KV_LENGTH)
      .def_readonly("support_history", &Qwen2_5VL::support_history)
      .def_readonly("history_length", &Qwen2_5VL::history_length);
}